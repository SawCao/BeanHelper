...
import com.sawcao.beanoperation.copier.CachedBeanCopier;
import com.sawcao.beanoperation.copier.FastClonerHashMap;
import com.sawcao.beanoperation.copier.Immutable;
import com.sawcao.beanoperation.tests.cloning.TestBeanHelper.SynthOuter.Inner;
import com.sawcao.beanoperation.tests.cloning.domain.*;
...
public class TestBeanHelper extends TestCase {
    ...
    {
        beanHelper.setDumpClonedClasses(false);
    }
    ...
    public void testCalendarTimezone() {
        ...
        Calendar cloned = beanHelper.deepClone(c);
    ...
    public void testCloneEnumInMapIssue20() {
        ...
        m.put(2, TestEnum.B);
        m.put(3, TestEnum.C);
        Map<Integer, TestEnum> clone = beanHelper.deepClone(m);
    ...
    public void testCustomAnnotation() {
        ...
        final MyAX c = beanHelper.deepClone(o);
        assertSame(o, c);
    }
    ...
    public void testConsiderImmutable() {
        ...
        final Object c = beanHelper.deepClone(o);
        assertSame(o, c);
    }
    ...
    public void testCloningOfSameObject() {
        ...
        oo.o3 = o1;
        oo.o4 = o2;
        OO clone = beanHelper.deepClone(oo);
    ...
    public void testCloneImmutables() {
        ...
        final String clone1 = beanHelper.deepClone(s);
        assertSame(s, clone1);
    }
    ...
    public void testCloneFloat() {
        ...
        final Float cloned = beanHelper.deepClone(float1);
    ...
    /**
     * tests copier of a simple class
     */
    public void testCloneSimple() {
        final Simple simple = new Simple();
        simple.setS("x1");
        simple.setX(20);
        final Simple clone = beanHelper.deepClone(simple);
    ...
    /**
     * test copier of a complex object graph
     */
    public void testCloneComplex() {
        final Complex complex = new Complex();
        complex.setS("x1");
        complex.setX(20);
        final Complex clone = beanHelper.deepClone(complex);
    ...
    public void testShallowClone() {
        ...
        final Simple shallowClone = beanHelper.shallowClone(simple1);
    ...
    public void testCloneStack() {
        ...
        final List<Integer> clone = beanHelper.deepClone(lst);
    ...
    public void testCloneTreeSet() {
        ...
        //		beanHelper.setDumpClonedClasses(true);

        final TreeSet<DC> set2 = beanHelper.deepClone(set);
    ...
    public void testArrayListCloning() {
        ...
        final ArrayList<Object> cloned = beanHelper.deepClone(l);
    ...
    public void testLinkedListCloning() {
        ...
        final LinkedList<Object> cloned = beanHelper.deepClone(l);
        assertEquals(l.size(), cloned.size());
        for (int i = 0; i < l.size(); i++) {
            assertEquals(l.get(i), cloned.get(i));
        }
    ...
    public void testHashSetCloning() {
        ...
        final HashSet<Object> cloned = beanHelper.deepClone(l);
        assertNotSame(l, cloned);
        assertEquals(l.size(), cloned.size());
    ...
    public void testHashMapCloning() {
        ...
        m.put("tina", 500);
        m.put("george", "Ah!");
        final HashMap<String, Object> cloned = beanHelper.deepClone(m);
    ...
    public void testTreeMapCloning() {
        ...
        m.put("tina", 500);
        m.put("george", "Ah!");
        final TreeMap<String, Object> cloned = beanHelper.deepClone(m);
        assertEquals(m.size(), cloned.size());
        for (final Map.Entry<String, Object> e : m.entrySet()) {
            assertEquals(e.getValue(), cloned.get(e.getKey()));
        }
    ...
    public void testTransientNullPositive() {
        final BeanHelper c = new BeanHelper();
    ...
    public void testCopyPropertiesArrayPrimitive() {
        ...
        beanHelper.copyPropertiesOfInheritedClass(src, dest);
    ...
    public void testCopyPropertiesInheritedClasses() {
        ...
        b.setX(-1);
        b.setY(10);
        beanHelper.copyPropertiesOfInheritedClass(a, b);
    ...
    public void testFreezable() {
        final F f = new F();
        assertNotSame(f, beanHelper.deepClone(f));
        f.setFrozen(true);
        assertSame(f, beanHelper.deepClone(f));
    }
    ...
    public void testDeepCloneDontCloneInstances() {
        ...
        final B b = new B();
        final G g = new G(a, b);
        final G cga = beanHelper.deepCloneDontCloneInstances(g, a);
        assertNotSame(g, cga);
        assertNotSame(cga.getB(), b);
        assertSame(cga.getA(), a);

        final G cgab = beanHelper.deepCloneDontCloneInstances(g, a, b);
    ...
    public void testDontCloneSynthetic() {
        final BeanHelper beanHelper = new BeanHelper();
        beanHelper.setCloneSynthetics(false);
        final SynthOuter outer = new SynthOuter();
        final Inner inner = outer.getInner();
        final Inner clonedInner = beanHelper.deepClone(inner);
    ...
    public void testTreeMapWithComparator() {
        ...
        final TreeMap<Object, String> clone = beanHelper.deepClone(m);
    ...
    public void testTreeSetWithComparator() {
        ...
        final TreeSet<Object> clone = beanHelper.deepClone(set);
        assertEquals(set, clone);
    }

    public void testEnumIssue9() {
        final TestEnum original = TestEnum.A;
        final TestEnum clone = beanHelper.deepClone(original);
    ...
    public void testDate() {
        ...
        beanHelper.setNullTransient(true);
        Date clone = beanHelper.deepClone(original);
    ...
    public void testUnregisterFastCloner() {
        BeanHelper beanHelper = new BeanHelper();
        beanHelper.unregisterFastCloner(HashMap.class);
        beanHelper.registerFastCloner(HashMap.class, new FastClonerHashMap());
    }

    public void testEmptyLinkedHashMap() {
        LinkedHashMap<Integer, Integer> m = new LinkedHashMap<Integer, Integer>();
        LinkedHashMap<Integer, Integer> cloned = beanHelper.deepClone(m);
    ...
    public void testCloneArrayListSubList() {
        ...
        assertEquals(1, beanHelper.deepClone(b).size()); // throws ConcurrentModificationException
    }
    ...
    public void testCloneLinkedListSubList() {
        ...
        List<String> clone = beanHelper.deepClone(b);
    ...
    public void testHashMapIterator() {
        ...
        Iterator<Map.Entry<Integer, String>> cIt = beanHelper.deepClone(it);
        cIt.next(); // throws ConcurrentModificationException
    }

    public void testDeepCopyBean() {
        DeepCopyBean1 deepCopyBean1 = new DeepCopyBean1();
        HashMap<String,HashMap<String, String>> hashMapStringHashMap1 = new HashMap<>();
        HashMap<String, String> map1 = new HashMap<>();
        List<String> stringList = new ArrayList<>();
        stringList.add("testList1");
        stringList.add("testList2");
        map1.put("testKey1", "testValue1");
        hashMapStringHashMap1.put("test1",map1);
        Date date = new Date(System.currentTimeMillis());
        deepCopyBean1.setTestNestHash(hashMapStringHashMap1);
        deepCopyBean1.setTestHash(map1);
        deepCopyBean1.setDate1(date);
        deepCopyBean1.setDate2(date);

        String testDateStr = beanHelper.beanToJson(deepCopyBean1);

        DeepCopyBean2 deepCopyBean2 = new DeepCopyBean2();
        beanHelper.deepCloneDiffClass(deepCopyBean1, deepCopyBean2);
        Map map = new HashMap();
        map = beanHelper.beanToMap(deepCopyBean1);

        DeepCopyBean1 deepCopyBean11 = new DeepCopyBean1();
        map.put("sada","sadad");
        deepCopyBean11 = beanHelper.mapToBean(map,deepCopyBean11);

        String str = beanHelper.beanToJson(deepCopyBean1);

/*        Long start = System.currentTimeMillis();
        for (int i = 0; i <= 1; i++) {
            DeepCopyBean2 deepCopyBean2= new DeepCopyBean2();
            beanHelper.nullInsteadOfClone(HashMap.class);
            beanHelper.deepCloneDiffClass(deepCopyBean1,deepCopyBean2);
            System.err.print("sad");
        }
        System.err.print("\n\n" + "Deep copy " + (System.currentTimeMillis() - start) + "\n\n");
        ...
        System.err.print("Shallow copy " + (System.currentTimeMillis() - start) + "\n\n");*/
