package com.sawcao.beanoperation.perspectives;
...
public class Perspectives
{
	...
	public Perspectives(final BeanHelper beanHelper)
	{
	...
	public <T, E extends T> E viewAs(final Class<E> c, final T o)
	{
		...
		final E newInstance = beanHelper.fastCloneOrNewInstance(c);
		beanHelper.copyPropertiesOfInheritedClass(o, newInstance);
		return newInstance;
	}
